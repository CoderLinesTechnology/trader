...
import ccxt  # Real-time market data
import time
...
def main():
    ...
    dp.add_handler(CommandHandler("start", lambda u, c: u.message.reply_text("🚀 Crypto Prediction Bot\nUse /predict [coin_id]")))
    dp.add_handler(CommandHandler("predict", analyze_crypto))
